...
export type GetMeSipQuery = { getMe: { id: string, email: string, name: string, role: UserRole, projects?: Array<{ id: string, title: string, status: ProjectStatus, updatedAt: any, likeCount: number, contact: string, isLiked: boolean, clubs: Array<{ id: string, name: string }> }> | null } };
...
export type GetProjectsQuery = { getProjects: { count: number, projects?: Array<{ id: string, title: string, updatedAt: any, contact: string, likeCount: number, isLiked: boolean, clubs: Array<{ id: string, name: string }>, createdBy: { name: string } }> | null } };
