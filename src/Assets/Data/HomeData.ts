export const TopNewsData = [
  ...
  {
    title:
      "Team Avishkar wins accolades in European Hyperloop Week (EHW) July 2021",
  ...
  {
    title:
      "#BloodSweatGasoline, Team Raftar Formula Racing roars into second place, announcing its arrival!!",
