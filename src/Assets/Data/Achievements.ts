...
import Achievements6 from "../Images/Achievements/Achievements6.jfif";
...
import Achievements1 from "../Images/Achievements/Achievements1.jpeg";
...
export const AchievementsData = [
  ...
  },
  {
    ...
    description:
      "IIT Madras rocketry team - Team Abhyuday (ex Aether) is a group of 20+ students from IIT Madras who have been selected by the Experimental Sounding Rocket Association (ESRA) to participate in the Spaceport America Cup 2022 edition - the world's largest Intercollegiate Rocket Engineering Competition for student rocketry teams from all around the world.  Team Abhyuday has already set new records by becoming the first-ever rocketry team across IITs to qualify for Spaceport America Cup. In fact, there were very few available competition slots for new teams, but Team Abhyuday made it nevertheless. This has been no small feat, considering the fact that the team was formed during the pandemic, and they haven’t met in person once.",
    image: Achievements4,
  },
  {
  ...
  },
  {
    ...
    date: "July, 2021",
    description:
      "Team Avishkar Hyperloop was awarded the Most Scalable Design Award by Zeleros Hyperloop at the European Hyperloop Week (EHW) 2021 in July '21. They were also nominated among the top 5 teams around the globe in mechanical, levitation, propulsion, and complete pod award categories at the EHW ’21. Team Avishkar Hyperloop was the only team competing virtually to have won an award and also the only virtually participating team with top 5 in these many categories.<br /> The team also hosted a pod run demonstration event at the IITM campus in July ’21, which was attended by Dr. VK Saraswat (Hon’ble Member of NITI Aayog), Mr. Vellayan Subbiah (MD, TII), IITM Director, the Dean of Students, our advisors, sponsors, and various industry leaders. Their efforts received acclamation from various print media channels and news channels like NDTV, India Today, and many more, in July ‘21.",
    image: Achievements1,
  },
];
