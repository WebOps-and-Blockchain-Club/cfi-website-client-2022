...
export const ClubList = [
  ...
  },
  {
    name: "IGem",
    logo: iGEMLogo,
    link: "/clubs/igem-club",
  },
  {
    name: "Team Envisage",
    logo: EnvisageLogo,
    link: "/clubs/envisage-club",
  },
  {
    name: "iBot Club",
    logo: iBotLogo,
  ...
  {
    name: "Astronomy & Physics Club",
    logo: HorizonLogo,
    link: "/clubs/astronomy-and-physics-club",
  },
  {
    name: "Sahaay",
    logo: AeroLogo,
    link: "/clubs/sahaay-club",
  },
  {
    name: "Product Design Club",
    logo: ProductDesignLogo,
    link: "/product-design-club",
  },
  {
    name: "Webops and Blockchain club",
    logo: WebOpsAndBlockchainLogo,
    link: "/webops-and-blockchain-club",
  },
];
...
export const CFIClubs = [
  "Clubs at CFI are its functioning organs. Divided based on interest, each club represents a student group highly enthusiastic in that specific field. Knowledge transfer, resulting in reducing the learning period is the strength of clubs at CFI.",
